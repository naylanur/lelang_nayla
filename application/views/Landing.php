                ...
                <div id="oleezLandingCarousel" class="oleez-landing-carousel carousel slide" data-ride="carousel">
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                            <img src="<?= base_url('landing/') ?>assets/images/Banner_1@2x.jpg" alt="First slide" class="w-100">
                        ...
                        <div class="carousel-item">
                            <img src="<?= base_url('landing/') ?>assets/images/Banner_2@2x.jpg" alt="Second slide" class="w-100">
                            <div class="carousel-caption">
                        ...
                        <div class="carousel-item">
                            <img src="<?= base_url('landing/') ?>assets/images/Banner_3@2x.jpg" alt="Third slide" class="w-100">
                            <div class="carousel-caption">
                                <h2 data-animation="animated fadeInRight"><span>Lelang</span></h2>
                                <h2 data-animation="animated fadeInRight"><span>computer</span></h2>
                                <a href="<?= base_url('auth') ?>" class="carousel-item-link" data-animation="animated fadeInRight">MARI LOGIN</a>
