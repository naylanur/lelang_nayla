<div class="container-fluid">
        ...
        <div class="card border-dark">
            ...
            ($product->harga_akhir, 2, ',','.'); ?> </strong>
            <br><br>

            <?php if ($product->pemenang == $this->session->userdata('username')) : ?>
                    <a href="<?= base_url('history/cetak_pemenang/') . $product->id_lelang?>" 
                    class="btn btn-primary">Cetak bukti menang</a>
           <?php endif; ?>
